...
<nav class="navbar navbar-expand-lg bg-danger navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s"> <a href="#" class="navbar-brand ms-3 d-lg-none">MENU</a>
  ...
  <div class="navbar-nav me-auto p-3 p-lg-0"> <a href="<?= site_url('first') ?>" class="nav-item nav-link " aria-label="Toggle navigation">Home</a> <a href="<?= site_url('first') ?>" class="nav-item nav-link " aria-label="Toggle navigation">Pengembang</a>
    <?php if(menu_atas) : ?>
