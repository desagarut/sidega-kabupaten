...
<script>
  ...
  <?php if (!empty($kabupaten['path'])): ?>
    var polygon_desa = <?= $kabupaten['path']; ?>;
    var kantor_kabupaten = L.polygon(polygon_desa, style_polygon).bindTooltip("Wilayah Desa").addTo(wilayah_desa);
    wilayah_desa.fitBounds(kantor_kabupaten.getBounds());
  <?php endif; ?>
</script>
...
<div class="box box-primary box-solid">
	...
	<div class="box-body">
		...
		<div id="collapse2" class="panel-collapse collapse">
			<br>
			<?php if (is_file(FCPATH . LOKASI_LOGO_KABUPATEN . $kabupaten['kantor_kabupaten'])): ?>
				<img class="img-responsive" src="<?=gambar_kabupaten($kabupaten['kantor_kabupaten'], TRUE)?>" alt="Kantor Desa">
				<hr>
			<?php endif; ?>
			<div class="info-desa">
				<table class="table-info">
					...
					<tr>
						...
						<td>:</td>
						<td width="70%"><?=$kabupaten['nama_desa']?></td>
					</tr>
					<tr>
						<td width="25%"><?=ucwords($this->setting->sebutan_kecamatan)?></td>
						<td>:</td>
						<td width="70%"><?=$kabupaten['nama_kecamatan']?></td>
					</tr>
					<tr>
						<td width="25%"><?=ucwords($this->setting->sebutan_kabupaten)?></td>
						<td>:</td>
						<td width="70%"><?=$kabupaten['nama_kabupaten']?></td>
					</tr>
					<tr>
						<td width="25%">Kodepos</td>
						<td>:</td>
						<td width="70%"><?=$kabupaten['kode_pos']?></td>
					</tr>
					<tr>
						<td width="25%">Telepon</td>
						<td>:</td>
						<td width="70%"><?=$kabupaten['telepon']?></td>
					</tr>
					<tr>
...
<?php else: ?>
	var center = { lat: <?=$kabupaten['lat'].", lng: ".$kabupaten['lng']?> };
<?php endif; ?>
