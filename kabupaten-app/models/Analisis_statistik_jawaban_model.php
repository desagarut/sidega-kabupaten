<?php class Analisis_statistik_jawaban_model extends MY_Model {
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		switch ($subjek)
		{
			...
			case 3: $sbj = "LEFT JOIN tweb_rtm v ON r.id_subjek = v.id LEFT JOIN tweb_penduduk p ON v.nik_kepala = p.id LEFT JOIN tweb_wil_cluster a ON p.id_cluster = a.id "; break;
