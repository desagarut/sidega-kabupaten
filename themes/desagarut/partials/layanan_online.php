...
<?php
	...
	if( ! isset($_SESSION['mandiri']) OR $_SESSION['mandiri']<>1) {
		...
		if($_SESSION['mandiri_wait'] == 1) { ?>
                ...
                <h3 class="sidebar-title">Layanan <?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?></h3>
	...
	?>
				...
				<h3 class="sidebar-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?></h3>

				<ul id="ul-mandiri"><small>
				...
				<table id="mandiri" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td colspan="3"><h4><a href="<?php echo site_url();?>mandiri_web/mandiri/1/2" class=""><button type="button" class="btn btn-primary btn-block">Buat Surat</button></a> </h4></td>

					</tr>

					<tr>

						<td colspan="3"><h4><a href="<?php echo site_url();?>mandiri_web/mandiri/1/3" class=""><button type="button" class="btn btn-primary btn-block">Pesan Masuk</button></a> </h4></td>

					</tr>

					<tr>

						<td colspan="3"><h4><a href="<?php echo site_url();?>mandiri_web/mandiri/1/4" class=""><button type="button" class="btn btn-primary btn-block">Program Bantuan</button></a></h4></td>

					</tr>

					<tr>

						<td colspan="3"><h4><a href="<?php echo site_url('mandiri_web');?>"  class=""><button type="button" class="btn btn-primary btn-block">Kembali </button></a></h4></td>
		...
		<?php if(isset($_SESSION['lg']) AND $_SESSION['lg'] == 1) { ?>
					...
					<h5 class="sidebar-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?></h5><br />
		...
		<?php } else if(isset($_SESSION['lg']) AND $_SESSION['lg'] == 2) { ?>
					...
					<h3 class="box-title"><i class="fa fa-user"></i> Layanan <?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?></h3><br />
