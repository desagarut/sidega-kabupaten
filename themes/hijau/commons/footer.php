...
<footer id="footer">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          <h4>Tautan</h4>
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="<?= site_url('first') ?>">Beranda</a></li>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          <h4>UMKM <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></h4>
          <ul>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="<?= $kabupaten['web_kecamatan']; ?>">Kecamatan
              <?= $kabupaten['nama_kecamatan']; ?>
              </a></li>
          </ul>
        </div>
  ...
  <div class="container d-md-flex py-4">
    <div class="mr-md-auto text-center text-md-left">
      ...
      <div class="copyright"><?= ucfirst($this->setting->sebutan_kecamatan).' '.ucwords($kabupaten['nama_kecamatan']) ?> &copy;
