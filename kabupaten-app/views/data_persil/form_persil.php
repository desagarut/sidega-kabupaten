									...
									<div class="box-body">
										...
										<div class="form-group ">
											...
											<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
												<label  class="btn btn-info btn-box btn-sm col-sm-3 form-check-label <?= $persil["lokasi"] ? NULL : 'active' ?>">
												...
												<label  class="btn btn-info btn-box btn-sm col-sm-3 form-check-label <?= $persil["lokasi"] ? 'active' : NULL ?>">
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<select class="form-control input-sm required" id="kelas" name="letterc_awal" type="text" <?php $persil and print('disabled')?> placeholder="Letter-C pemilik awal persil ini" >
													<option value="">-- Pilih Letter-C Pemilik Awal --</option>
													<?php foreach ($list_letterc  as $letterc): ?>
														<option value="<?= $letterc['id_letterc'] ?>" <?php (($id_letterc and $id_letterc == $letterc["id_letterc"]) or ($letterc['id_letterc'] and $letterc['id_letterc'] == $persil["letterc_awal"])) and print('selected'); ?>><?= $letterc['nomor'].' - '.$letterc['namapemilik']?></option>
													<?php endforeach;?>
												</select>
											</div>
										</div>
