								...
								<div class="box-body">
									...
									<div id="form-melengkapi-data-peserta">
										<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
											...
											<?php if ($individu): ?>
												<?php include("kabupaten-app/views/covid19/vaksin/konfirmasi_peserta_vaksin.php"); ?>
											<?php endif; ?>

											<?php include("kabupaten-app/views/covid19/vaksin/form_isian_peserta_vaksin.php"); ?>
	...
	<div class='modal-dialog'>
		<div class='modal-content'>
			...
			<div class='modal-body'>
				<div class="row">
					<?php include("kabupaten-app/views/covid19/vaksin/form_isian_penduduk.php"); ?>
				</div>
			</div>
