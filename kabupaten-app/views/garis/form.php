						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="btn-group col-xs-12 col-sm-9" data-toggle="buttons">
									<label id="sx3" class="btn btn-info btn-box btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($garis['enabled'] =='1' OR $garis['enabled'] == NULL): ?>active<?php endif ?>">
									...
									<label id="sx4" class="btn btn-info btn-box btn-sm col-xs-6 col-sm-4 col-lg-2 form-check-label <?php if ($garis['enabled'] == '2' ): ?>active<?php endif ?>">
