...
// RFM access key dibuat di kabupaten-app/models/User_model.php pada waktu login
...
$config = array(
		...
		*/
		...
		|
		*/
		'upload_dir' => '/../kabupaten/upload/media/',
		/*
		|--------------------------------------------------------------------------
		...
		|
		*/
		'current_path' => '../../kabupaten/upload/media/',
		...
		|
		*/
		'thumbs_base_path' => '../../kabupaten/upload/thumbs/',
		...
		|
		*/
		'thumbs_upload_dir' => '/kabupaten/upload/thumbs/',
