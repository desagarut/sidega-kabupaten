		...
		<div id="container">
			<div id="body">
				<div class="header" align="center">
					<h3>A.1 BUKU PERATURAN DESA <?= strtoupper($kabupaten['nama_desa'])?></h3>
					<h3><?= strtoupper($this->setting->sebutan_kecamatan.' '.$kabupaten['nama_kecamatan'].' '.$this->setting->sebutan_kabupaten.' '.$kabupaten['nama_kabupaten'])?></h3>
				...
				<table id="ttd">
					...
					<tr>
						...
						<td colspan="3"><span class="underline"><?= strtoupper($this->setting->sebutan_desa.' '.$kabupaten['nama_desa'].', '.tgl_indo(date("Y m d")))?></span></td>
						<td colspan="2">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>
