...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="<?= base_url()?>assets/css/letterc.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		<div id="content" class="container_12 clearfix">
			<div id="content-main">
			 <div class="header">
				<h4 class="kop">LETTER C</h4>
				<h4 class="kop">NOMOR : <?= sprintf("%04s", $letterc['nomor'])?></h4>
				<h5 class="kop2">DESA <?= strtoupper($kabupaten["nama_desa"])?> KECAMATAN <?= strtoupper($kabupaten["nama_kecamatan"])?> KABUPATEN <?= strtoupper($kabupaten["nama_kabupaten"])?></h5>
			...
			<div id="isi">
				<table style="font-size: 14px;padding-left: 32px;margin-left: 7px; margin-bottom: unset;">
					<tr>
						...
						<td width="10">:</td>
						<td><b><?= strtoupper($letterc["namapemilik"])?></b></td>
					</tr>
					<tr>
						<td>ALAMAT</td>
						<td>:</td>
						<td><?= strtoupper($letterc["alamat"])?></td>
					</tr>
				</table>
				<div align="center">
						...
						<tr>
							<td class="info">
								<p>Keterangan:<br />
									...
									ASLI-nya pada Buku Letter-C Oleh Kepala Desa Atau<br />
									Sekretariat <?= ucwords(strtolower($this->setting->sebutan_desa))?> <?= ucwords(strtolower($kabupaten['nama_desa'])) ?>
								</p>
							</td>
							<td>
								<p align="center"> <?= $kabupaten['nama_desa'] ?>, <?= tgl_indo(date("Y m d"))?><br>
									Mengetahui <br>
									KEPALA  <?= strtoupper($this->setting->sebutan_desa)?> <?= strtoupper($kabupaten['nama_desa']) ?> <br>
									<br>
									<br>
									<br>
									<br>
