<div class="content-wrapper">
	<section class="content-header">
		<h1>WILAYAH ADMINISTRATIF KECAMATAN <?= $kecamatan ?></h1>
		<ol class="breadcrumb">
		<li><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Beranda</a></li>
			...
			<li class="active">Data Desa/Kelurahan</li>
		</ol>
	</section>
				...
				<div class="box box-info">
					<div class="box-header with-border">
						<?php if ($this->CI->cek_hak_akses('h')) : ?>
							<a href="<?= site_url("sid_core/form_desa/$id_kecamatan/$id_desa") ?>" class="btn btn-social btn-box btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Desa/Kelurahan</a>
						<?php endif; ?>
						...
						<a href="<?= site_url("sid_core") ?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Kecamatan">
							<i class="fa fa-arrow-circle-left "></i>Kembali ke Daftar <?= ucwords($this->setting->sebutan_kecamatan) ?>
						</a>
					</div>
					<div class="box-header with-border">
						<h4 class="text-center">DATA DESA WILAYAH <?= strtoupper($this->setting->sebutan_kecamatan) ?> <?= $kecamatan ?></h4>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-sm-12">
