    ...
    <div class="row">
            ...
            <div class="single-slider"
              ...
              <div class="content">
                ...
                <div class="button"> <a class="" href="<?= site_url('first/produk_show/'.$data['id']) ?>">
                  ...
                  </a> <a href="https://wa.me/+62<?= $data['no_hp_toko'] ?>?text=Assalamu'alaikum%2C%20Saya%20tertarik%20dengan%20produk%20yang%20ditawarkan%20di%20website%20*<?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>*.%20Apakah%20<?= $data['nama'] ?>%20masih%20buka%3F%20<?= site_url('first/produk_show/'.$data['id']) ?>" target="_blank" title="pesan">
      ...
      <div class="col-lg-4 col-12">
        <div class="row">
          ...
          <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></strong>, yang dikembangkan untuk membantu meningkatkan pertumbuhan ekonomi masyarakat desa.</p>
