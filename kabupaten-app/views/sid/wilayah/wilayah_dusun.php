				...
				<div class="box box-info">
					<div class="box-header with-border">
						<?php if ($this->CI->cek_hak_akses('h')) : ?>
							<a href="<?= site_url("sid_core/form_dusun/$id_kecamatan/$id_dusun") ?>" class="btn btn-social btn-box btn-success btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Dusun / Wilayah</a>
						<?php endif; ?>
						...
						<a href="<?= site_url("sid_core/sub_desa/$id_kecamatan") ?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Desa / Kelurahan">
													...
													<table class="table table-bordered table-striped dataTable table-hover">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<th width="25%">Nama Dusun</th>
																<th width="35%">Nama Kepala Dusun</th>
														...
														<tbody>
															...
															?>
																<tr>
																	...
																	<td nowrap>
																		<a href="<?= site_url("sid_core/sub_rw/$id_kecamatan/$id_desa/$data[id]") ?>" class="btn bg-purple btn-box btn-sm" title="Rincian Wilayah Kecamatan"><i class="fa fa-search"></i> Detail</a>
																		<?php if ($this->CI->cek_hak_akses('h')) : ?>
																			<a href="<?= site_url("sid_core/form_dusun/$id_kecamatan/$id_desa/$data[id]") ?>" class="btn bg-orange btn-box btn-sm" title="Ubah"><i class="fa fa-edit"></i></a>
																	...
																	<td class="bilangan"><a href="<?= site_url("sid_core/sub_rw/$data[id]") ?>" title="Rincian Sub Wilayah RW"><?= $data['jumlah_rt'] ?></a></td>
