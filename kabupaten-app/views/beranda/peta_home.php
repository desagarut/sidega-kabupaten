...
<script>
  ...
  <?php if (!empty($kabupaten['path'])): ?>
    ...
    var kantor_kabupaten = L.polygon(polygon_desa, style_polygon).bindTooltip("Wilayah <?=ucwords($this->setting->sebutan_desa).' '.$kabupaten['nama_desa']?>").addTo(wilayah_desa);
