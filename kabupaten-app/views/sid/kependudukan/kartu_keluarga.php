							...
							<div class="row">
								<div class="col-sm-8">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<p class="text-muted">: <?= strtoupper($kabupaten['nama_desa']) ?></p>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">KECAMATAN</label>
										<div class="col-sm-9">
											<p class="text-muted">: <?= strtoupper($kabupaten['nama_kecamatan']) ?></p>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-7">
											<p class="text-muted">: <?= strtoupper($kabupaten['nama_kabupaten']) ?></p>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-5 control-label">KODE POS</label>
										<div class="col-sm-7">
											<p class="text-muted">: <?= $kabupaten['kode_pos'] ?></p>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-5 control-label">PROVINSI</label>
										<div class="col-sm-7">
											<p class="text-muted">: <?= strtoupper($kabupaten['nama_propinsi']) ?></p>
										</div>
									</div>
									<div class="form-group">
										...
										<table class="table no-border">
											<tbody>
												<tr>
													<td width="25%">&nbsp;</td>
													<td width="50%">&nbsp;</td>
													<td class="text-center" width="25%"><?= $kabupaten['nama_desa'] ?>, <?= tgl_indo(date("Y m d"))?></td>
												</tr>
												<tr>
													<td class="text-center">KEPALA KELUARGA</td>
													<td>&nbsp;</td>
													<td class="text-center">KEPALA <?= strtoupper($this->setting->sebutan_desa)?> <?= strtoupper($kabupaten['nama_desa']) ?></td>
												</tr>
												...
												<tr>
													...
													<td width="50%">&nbsp;</td>
													<td class="text-center"><?= strtoupper($kabupaten['nama_kepala_desa']) ?></td>
												</tr>
											</tbody>
										</table>
									</div>
