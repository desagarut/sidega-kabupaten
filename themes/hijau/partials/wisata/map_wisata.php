    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          ...
          <p><strong>Toko Warga </strong>adalah informasi tentang seluruh pedagang yang ada di wilayah <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>, pedagang yang terdaftar dalam Toko Warga terdiri atas seluruh penduduk yang memiliki aktivitas perdagangan di wilayah <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>. Baik penduduk tetap, sementara, maupun penduduk luar desa.<br/>
