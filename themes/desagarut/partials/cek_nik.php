  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body non-nik">
      	<p>Maaf, NIK/KK yang anda cari belum ada pada sistem data kependudukan <?php echo ucwords($this->setting->sebutan_desa)." "?><?php echo ucwords($kabupaten['nama_desa'])?>.</p>
        <p>Silakan hubungi Operator atau datang ke Kantor <?php echo ucwords($this->setting->sebutan_desa)." "?> atau hubungi nomor telepon <?php echo $kabupaten['telepon']?> untuk melakukan pendataan data penduduk. </p>
        Terimakasih
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body nik-ada">
        <p>Selamat NIK/KK yang anda cari telah terdaftar pada sistem data kependudukan <?php echo ucwords($this->setting->sebutan_desa)." "?><?php echo ucwords($kabupaten['nama_desa'])?>. </p>
