...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById("map-wilayah-desa"), { center, zoom:<?=$kabupaten['zoom']?>, mapTypeId:google.maps.MapTypeId.<?=$kabupaten['map_tipe']?>});

    kantorDesa = new google.maps.Marker({
        position: center,
        map: map,
        title: 'Kantor <?php echo ucwords($this->setting->sebutan_desa)." "?><?php echo ucwords($kabupaten['nama_desa'])?>',
