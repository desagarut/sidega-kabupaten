...
<div class="row">
  <div class="col-md-12">
    <div class="member" data-aos="fade-up">
      <h4><i class="ri-store-2-fill" style="color:#e80368;"></i> Daftar Wisata <strong style="color:#606">
  ...
  <div class="col-lg-3 col-md-6 align-items-stretch owl-carousel portfolio-details-carousel">
    <div class="member" data-aos="fade-up">
      ...
      <div class="member-info" style="background-color:#EFDFFF">
        ...
        <p class="text-center"><strong>adalah </strong> fasilitas publik di wilayah <strong>
          <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>
  ...
  <div class="col-md-9 align-items-stretch">
    <div class="row">
      ...
      <div class="col-md-4 align-items-stretch owl-carousel portfolio-details-carousel">
        <div class="member"> <a href="<?= site_url('first/wisata_fasilitas/'.$data['id']) ?>"  title="Fasilitas">
          ...
          <div class="member-info">
            <h4> <strong style="color:#60C"><a class="" href="<?= site_url('first/wisata_fasilitas/'.$data['id']) ?>">
              <?= $data['nama'] ?>
              </a></strong></h4>
            <span style="color:#666" class="text-justify member-info-detail"> <strong>Kategori</strong> :
            <?= $data['jenis_wisata'] ?>
            </span> <span style="color:#666" class="text-justify member-info-detail"> <strong>Unik</strong> :
            <?= $data['daya_tarik_utama']?>
            </span> <span style="color:#666" class="text-justify member-info-detail"> <strong>Pengelola</strong> :
            <?= $data['nama_pengelola']?>
            </span> <span style="color:#666" class="text-justify member-info-detail"> <strong>Lokasi</strong> : <br/>
            <i>
            <?= $data['lokasi'] ?>
            </i><br/>
            <strong>Dari kantor
