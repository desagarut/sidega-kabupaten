...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?= site_url('tawa')?>">Detail Transportasi Warga</a></li>
      <li class="active">
        <?= $sub['nama']?>
      </li>
    </ol>
  ...
  <form id="mainform" name="mainform" action="" method="post">
      <div class="row">
          <div class="col-md-12">
              ...
              <div class="row">
            <?php $this->load->view($folder_themes .'/tawa/peta.php') ?>
          </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
          <div class="table-responsive">
            <table class="table table-bordered table-striped dataTable table-hover">
              ...
              <tr>
                  <td width="8%">Jenis Usaha</td><td width="17%"> <?=$sub['jenis_usaha']?></td>
                  <td width="8%">Kelompok Usaha</td><td width="17%"> <?=$sub['kelompok_usaha']?></td>
                  <td width="8%">Area Layanan</td><td width="17%"> <?=$sub['area']?></td>
              </tr>
              <tr>
                  <td width="8%">-</td><td width="17%">-</td>
      ...
      <div class="box box-warning">
          <div class="box-header with-border"><i class="fa fa-list"></i>
            ...
            <form id="mainform" name="mainform" action="" method="post">
              <div class="row">
                <div class="col-sm-6">
                  <select class="form-control input-sm " name="filter" onchange="formAction('mainform', '<?= site_url("tawa/filter/$gallery")?>')">
                    ...
                    <table class="table table-bordered table-striped dataTable table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$data['no']?></td>
                          <td nowrap><a href="<?=site_url("tawa/urut/$data[id]/1/$sub[id]")?>" class="btn bg-olive btn-box btn-sm"  title="Pindah Posisi Ke Bawah"><i class="fa fa-arrow-down"></i></a> <a href="<?=site_url("tawa/urut/$data[id]/2/$sub[id]")?>" class="btn bg-olive btn-box btn-sm"  title="Pindah Posisi Ke Atas"><i class="fa fa-arrow-up"></i></a>
                            <?php if ($data['enabled'] == '2'): ?>
                            <a href="<?= site_url("tawa/gallery_lock/".$data['id']."/$gallery")?>" class="btn bg-navy btn-box btn-sm"  title="Aktifkan Gambar"><i class="fa fa-lock">&nbsp;</i></a>
                            <?php elseif ($data['enabled'] == '1'): ?>
                            <a href="<?= site_url("tawa/gallery_unlock/".$data['id']."/$gallery")?>" class="btn bg-navy btn-box btn-sm"  title="Non Aktifkan Gambar"><i class="fa fa-unlock"></i></a>
                            <?php endif ?>
                            <br/>
                            <?php if ($this->CI->cek_hak_akses('h')): ?>
