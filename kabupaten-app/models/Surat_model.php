<?php class Surat_model extends CI_Model {
	...
	{
		$file_logo = APPPATH . '../' . LOKASI_LOGO_KABUPATEN . $nama_logo;
	...
	{
		$data_form = LOKASI_SURAT_KABUPATEN.$surat."/data_form_".$surat.".php";
	...
	{
		$data_rtf = LOKASI_SURAT_KABUPATEN.$surat."/data_rtf_".$surat.".php";
	...
	{
	  $lokasi = LOKASI_SURAT_KABUPATEN . $nama_surat . "/" . $komponen;
	...
	*/
	...
	public function surat_rtf($data)
	{
		...
		if (is_file($file))
		{
			...
			{
				$alamat_desa = "{$config['alamat']} Email: {$config['email']} Kode Pos: {$config['kode_pos']}";
				$alamat_surat = "{$config['alamat']} Telp. {$config['telepon']} Kode Pos: {$config['kode_pos']} \par Website: {$config['website']} Email: {$config['email']}";
			}
			else
			{
				$alamat_desa = "{$config['alamat']} Kode Pos: {$config['kode_pos']}";
				$alamat_surat = "{$config['alamat']} Telp. {$config['telepon']} Kode Pos: {$config['kode_pos']}";
			}
			$array_replace = array(
