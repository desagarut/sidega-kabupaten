		...
		<div id="body">
			...
			<table width="100%" cellpadding="3" cellspacing="4">
				<tr>
					...
					<td width="150">: <?= strtoupper($kabupaten['nama_kecamatan']) ?></td>
				</tr>
				<tr>
					<td>Alamat</td>
				...
				<tr>
					...
					<td>Kode Pos</td>
					<td>: <?= strtoupper($kabupaten['kode_pos']) ?></td>
				</tr>
				<tr>
					<td>Kelurahan/<?= ucwords($this->setting->sebutan_desa)?></td>
					<td>: <?= strtoupper($kabupaten['nama_desa']) ?></td>
					<td>Provinsi</td>
					<td>: <?= strtoupper($kabupaten['nama_propinsi']) ?></td>
				</tr>
			</table>
			...
			<table width="100%" cellpadding="3" cellspacing="4">
				<tr>
					<td width="25%"></td>
					<td width="50%"></td>
					<td width="25%" align="center"><?= $kabupaten['nama_desa'] ?>, <?= tgl_indo(date("Y m d"))?></td>
					</tr>
					<td width="25%" align="center">KEPALA KELUARGA</td>
					<td width="50%"></td>
					<td align="center" width="150">KEPALA <?= strtoupper($this->setting->sebutan_desa)?> <?= strtoupper($kabupaten['nama_desa']) ?></td>
				</tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
				...
				<tr>
					...
					<td width="50%"></td>
					<td width="25%" align="center" width="150"><?= strtoupper($kabupaten['nama_kepala_desa']) ?></td>
				</tr>
			</table>
		</div>
