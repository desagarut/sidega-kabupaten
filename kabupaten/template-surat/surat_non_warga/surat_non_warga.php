			...
			<div class="col-md-12">
                ...
                <div class="col-sm-4">
                  <select class="form-control input-sm" name="pekerjaan" id="pekerjaan">
							...
							<?php include("../../../kecamatan/template-surat/surat_non_warga/kabupaten-app/views/surat/form/_pamong.php"); ?>
						</form>
					</div>
					<?php include("../../../kecamatan/template-surat/surat_non_warga/kabupaten-app/views/surat/form/tombol_cetak.php"); ?>
				</div>
			</div>
		</div>
	</section>
