...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <?php if (is_file("kecamatan/css/insidega.css")): ?>
  ...
  <body>
    <div id="container">
      ...
      <div id="body">
        <table>
          <tr>
            <td colspan="10" class="text-bold"><span style="float: right; border: solid 1px black; font-size: 12pt; text-align: center; padding: 5px 20px;">LAMPIRAN A-9</span></td>
          </tr>
          <tr>
            <td colspan="8" class="judul" style="padding-bottom: 10px;">PEMERINTAH KABUPATEN <?= strtoupper($config['nama_kabupaten'])?></td>
          </tr>
          <tr>
            <td colspan="8" class="judul" style="padding-bottom: 20px;"><span style="border-bottom: 2px solid;">LAPORAN PERKEMBANGAN PENDUDUK</span></td>
          <tr>
            <tr>
              <td colspan="3" width="32%">&nbsp;</td>
              <td colspan="3" width="15%" class="text-bold"><?= ucwords($this->setting->sebutan_desa)?></td>
        ...
        <br>
        <?php include ("kabupaten-app/views/laporan/tabel_bulanan.php"); ?>
        <table class="tftable">
