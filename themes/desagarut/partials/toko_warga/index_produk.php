...
<div class="row">
  <div class="col-md-12">
    <div class="member" data-aos="fade-up">
      <h5><i class="ri-store-2-fill" style="color:#e80368;"></i> Daftar Produk <strong style="color:#060">
        <?= $sub['nama'] ?>
        </strong></h5>
    </div>
  </div>
    ...
    <div class="member">
      <div class="member-img"> <img src="<?= AmbilGaleri($sub['gambar'],'kecil') ?>" class="img-fluid" alt="<?= $sub['nama'] ?>" style="width:100%; height:225px">
        <div class="member-info" style="background-color:#FFD7EB">
          ...
          </a> <a href="https://wa.me/+62<?= $sub['no_hp_toko'] ?>?text=Assalamu'alaikum%2C%20Saya%20tertarik%20dengan%20produk%20yang%20ditawarkan%20di%20website%20<?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>.%20Apakah%20<?= $sub['nama'] ?>%20masih%20buka%3F" target="_blank" title="pesan">
