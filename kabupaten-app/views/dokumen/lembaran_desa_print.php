		...
		<div id="container">
			<div id="body">
				<div class="header" align="center">
					...
					<h4><?= strtoupper($this->setting->sebutan_desa.' '.$kabupaten['nama_desa']. $this->setting->sebutan_kecamatan.' '.$kabupaten['nama_kecamatan'].' '.$this->setting->sebutan_kabupaten.' '.$kabupaten['nama_kabupaten'])?></h4>
				...
				<table id="ttd">
					...
					<tr>
						...
						<td colspan="3" align="center"><span class="underline"><?= strtoupper($this->setting->sebutan_desa.' '.$kabupaten['nama_desa'].', '.tgl_indo(date("Y m d")))?></span></td>
						<td colspan="1">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="1">&nbsp;</td>
