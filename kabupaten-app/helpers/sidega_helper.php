...
define("LOKASI_LOGO_KABUPATEN", 'kabupaten/logo/');

define("LOKASI_ARSIP", 'kabupaten/arsip/');

define("LOKASI_CONFIG_KABUPATEN", 'kabupaten/config/');

define("LOKASI_SURAT_KABUPATEN", 'kabupaten/template-surat/');

define("LOKASI_SURAT_FORM_KABUPATEN", 'kabupaten/template-surat/form/');

define("LOKASI_SURAT_PRINT_KABUPATEN", 'kabupaten/template-surat/print/');

define("LOKASI_SURAT_EXPORT_KABUPATEN", 'kabupaten/template-surat/export/');

define("LOKASI_USER_PICT", 'kabupaten/upload/user_pict/');

define("LOKASI_GALERI", 'kabupaten/upload/galeri/');

define("LOKASI_FOTO_ARTIKEL", 'kabupaten/upload/artikel/');

define("LOKASI_FOTO_LOKASI", 'kabupaten/upload/gis/lokasi/');

define("LOKASI_FOTO_AREA", 'kabupaten/upload/gis/area/');

define("LOKASI_FOTO_GARIS", 'kabupaten/upload/gis/garis/');

define("LOKASI_DOKUMEN", 'kabupaten/upload/dokumen/');

define("LOKASI_PENGESAHAN", 'kabupaten/upload/pengesahan/');

define("LOKASI_WIDGET", 'kabupaten/widgets/');

define("LOKASI_GAMBAR_WIDGET", 'kabupaten/upload/widgets/');

define("LOKASI_KEUANGAN_ZIP", 'kabupaten/upload/keuangan/');

define("LOKASI_MEDIA", 'kabupaten/upload/media/');

define("LOKASI_SIMBOL_LOKASI", 'kabupaten/upload/gis/lokasi/point/');

define("LOKASI_SIMBOL_LOKASI_DEF", 'assets/images/gis/point/');

define("LOKASI_RUMAH", 'kabupaten/upload/dokumen/');
 ...
 * Mengembalikan path lengkap untuk file favico kabupaten
...
function favico_kabupaten()

{

	$favico = 'favicon.ico';

	$favico_kabupaten = (is_file(APPPATH .'../'. LOKASI_LOGO_KABUPATEN . $favico)) ?

		base_url() . LOKASI_LOGO_KABUPATEN . $favico :

		base_url() . $favico;

	return $favico_kabupaten;
 ...
 * gambar_kabupaten / Kantor kabupaten

 *

 * Mengembalikan path lengkap untuk file logo kabupaten / kantor kabupaten
...
function gambar_kabupaten($nama_file, $type = FALSE, $file = FALSE)

{

	if (is_file(APPPATH .'../'. LOKASI_LOGO_KABUPATEN . $nama_file))

	{



		return $logo_kabupaten = ($file ? APPPATH.'../' : base_url()) . LOKASI_LOGO_KABUPATEN . $nama_file;
	...
	return $logo_kabupaten = ($file ? APPPATH.'../' : base_url()). "assets/files/logo/$default";
 ...
 * Mengembalikan path file konfigurasi database kabupaten
...

{
	...
	$konfigurasi_database = LOKASI_CONFIG_KABUPATEN . 'database.php';
 ...
 * lokasi : lokasi folder berkas berada (contoh : kabupaten/arsip)
...

{
...

	{
...

		{
			...
			include(FCPATH . 'kabupaten-app/views/errors/html/error_404.php');
...

{
	...
	$kode_kabupaten = (strlen($kode_wilayah) > 6) ? '.' . substr($kode_wilayah, 6) : '';

	$kode_standar = implode('.', $kode_prov_kab_kec) . $kode_kabupaten;
