  ...
  <section class="sidebar">
		<div class="user-panel" style="padding-top:10px">
			...
			<div class="pull-left info">
				<strong><?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?></strong>
				</br>
				<?php
					$seb_kec = $this->setting->sebutan_kecamatan;
					$nam_kec = $kabupaten['nama_kecamatan'];
					$seb_kab = $this->setting->sebutan_kabupaten;
					$nam_kab = $kabupaten['nama_kabupaten'];
				?>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li> <a href="<?= site_url();?>mandiri_web/mandiri/1/1"><i class="fa fa-tachometer"></i> <span> Beranda</span> </a> </li>
