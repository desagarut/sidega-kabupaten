		...
		<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
			<div class="box box-info">
				<div class="box-header with-border">
					...
					<?php else: ?>
						<a href="<?= site_url("$this->controller/index/$kat"); ?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Artikel">
							<i class="fa fa-arrow-circle-left "></i>Kembali Ke Daftar <?= $kat_nama?>
						</a>
					<?php endif; ?>
				</div>
				<div class="box-body">
					...
					<?php
						if ($kat == 2 or $dokumen['kategori'] == 2)
							include ("kabupaten-app/views/dokumen/_sk_kades.php");
						elseif ($kat == 3 or $dokumen['kategori'] == 3)
							include ("kabupaten-app/views/dokumen/_perdes.php");
						else
							include ("kabupaten-app/views/dokumen/_informasi_publik.php");
					?>
				</div>
