			...
			<div class="col-md-9">
				<div class="box box-info">
					<div class="box-header">
							...
							<?php else: ?>
								<h4 class="text-center"><strong>Sebab Dan Tanggal Perubahan Persil <?= $persil_mutasi["nama"] ?> / Letter-C <?= $persil_mutasi["letterc"] ?></strong></h4>
							<?php endif; ?>
					...
					<form id="validasi" action="<?= $form_action?>" method="POST" class="form-horizontal">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input name="no_letterc"  type="text"  class="form-control input-sm angka" placeholder="Nomor Letter-C" value="<?= $persil_mutasi["no_letterc"] ?>">
								</div>
							</div>
							<div class="form-group">
