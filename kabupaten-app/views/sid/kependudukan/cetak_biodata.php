		...
		<div id="content" class="container_12 clearfix">
			<div id="content-main" class="grid_7">
				...
				<table width="100%" style="border: solid 0px black; text-align: center;">
					<tr>
						<td align="center"><img src="<?= gambar_kabupaten($kabupaten['logo']);?>" alt="<?= $kabupaten['nama_desa']?>"  class="logo_mandiri">
					</tr>
					<tr>
						</td>
						<td>
							<h3>BIODATA PENDUDUK WARGA NEGARA INDONESIA</h3>
							<h5><?= ucwords($this->setting->sebutan_kabupaten_singkat)?> <?= $kabupaten['nama_kabupaten']?>, <?= ucwords($this->setting->sebutan_kecamatan_singkat)?> <?= $kabupaten['nama_kecamatan']?>, <?= ucwords($this->setting->sebutan_desa)?> <?= $kabupaten['nama_desa']?></h5>
						</td>
					</tr>
				</table>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td align="center" scope="col" width="50%"><?= ucwords($this->setting->sebutan_desa . ' '. $kabupaten['nama_desa']) . ', ' . tgl_indo(date("Y m d"))?></td>
					</tr>
					<tr>
						<td align="center">&nbsp;</td>
						<td align="center">&nbsp;</td>
						<td align="center">Kepala <?= ucwords($this->setting->sebutan_desa . ' ' . $kabupaten['nama_desa']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="center">&nbsp;</td>
						<td align="center"><b>( <?= $kabupaten['nama_kepala_desa']?> )</b></td>
					</tr>
				</table>
			</div>
			<div id="aside">
