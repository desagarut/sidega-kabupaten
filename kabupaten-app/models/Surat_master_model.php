<?php class Surat_master_model extends MY_Model {
	...
	public function insert()
	{
		...
		$folder_surat = LOKASI_SURAT_KABUPATEN.$data['url_surat']."/";
	...
	public function upload($url="")
	{
		...
		$folder_surat = LOKASI_SURAT_KABUPATEN.$url."/";
		if (!file_exists($folder_surat))
		{
	...
	// Lampiran surat perlu disalin ke folder surata di LOKASI_SURAT_KABUPATEN, karena
  ...
  public function get_kode_isian($surat)
  {
    ...
    $path_lokal = FCPATH . LOKASI_SURAT_KABUPATEN .$surat['url_surat']."/".$surat['url_surat'].".php";
	...
	{
		$folder_surat_desa = glob(LOKASI_SURAT_KABUPATEN.'*' , GLOB_ONLYDIR);
		foreach ($folder_surat_desa as $surat)
		{
			$surat = str_replace(LOKASI_SURAT_KABUPATEN, '', $surat);
