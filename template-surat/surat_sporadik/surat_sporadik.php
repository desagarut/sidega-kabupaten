						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-horizontal">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input name="desalurah" class="form-control input-sm" type="text" placeholder="Desa / Kelurahan" value="<?= $kabupaten['nama_desa']?>">
									</div>
								</div>
								<div class="form-group">
									<label for="camatt"  class="col-sm-3 control-label">Kecamatan</label>
									<div class="col-sm-8">
										<input name="camatt" class="form-control input-sm" type="text" value="<?= $kabupaten['nama_kecamatan']?>">
									</div>
								</div>
								<div class="form-group">
									<label for="kabb"  class="col-sm-3 control-label">Kabupaten / Kota</label>
									<div class="col-sm-8">
										<input name="kabb" class="form-control input-sm" type="text" value="<?= $kabupaten['nama_kabupaten']?>">
									</div>
								</div>
								<div class="form-group">
							...
							<div class="col-md-12">
								...
								<?php if ($saksi1): //bagian info setelah terpilih
									$individu = $saksi1;
									include("kabupaten-app/views/surat/form/konfirmasi_pemohon.php");
								endif; ?>
