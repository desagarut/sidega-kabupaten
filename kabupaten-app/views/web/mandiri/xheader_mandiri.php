...
<div class="wrapper">
  <header class="main-header"> <a href="<?=site_url()?>mandiri_web"  target="_blank" class="logo"> <span class="logo-mini logo-text" style="padding-top:7px"><img src="<?php echo base_url().'kecamatan/logo/logo.png'; ?>" class="img-circle logo-deskel" alt="User Image" width="30px"></span> <span class="logo-lg logo-text"><img src="<?php echo base_url().'kecamatan/logo/logo.png'; ?>" class="img-circle logo-deskel" alt="User Image" width="30px"> SIDeGa </span> </a>
