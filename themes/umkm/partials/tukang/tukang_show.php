    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          ...
          <p>Berbagai usaha jasa berdasakan keahlian masyarakat di wilayah <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></p>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-3 col-md-6 col-12"> 
        ...
        <div class="single-product">
          ...
          <div class="product-info"> 
            ...
            <a href="https://wa.me/+62<?= $data['no_hp_pengelola'] ?>?text=Assalamu'alaikum%2C%20halo%20saya%20tertarik%20dengan%20keahlian%20anda%20yang%20ditawarkan%20di%20website%20*<?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?>*.%20Saya%20ada%20pekerjaan%20yang%20mungkin%20cocok%20dengan%20keahlian%20anda.%20Apakah%20kita%20dapat%20membicarakannya%20lebih%20lanjut%3F%20<?= site_url('first/tukang_layanan/'.$data['id']) ?>" target="_blank" title="pesan">
