	...
	<link rel="stylesheet" href="<?= base_url()?>assets/css/AdminLTE.css" />
        ...
        <script src="https://dev.sindangsari.kecamatancisompet.id/assets/bootstrap/js/bootstrap.min.js"></script>
		<!-- Ionicons -->
	...
	.highcharts-data-table tr:hover {
		...
		<div class="box box-info">
			<div class="box-header">
                <h1>Status IDM <?= ucwords($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa'])?> </h1>
            </div>
			<div class="box-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="row">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kiri">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kiri status-idm-kanan">
							...
							<div class="col-sm-3 col-xs-3 status-idm-kanan">
