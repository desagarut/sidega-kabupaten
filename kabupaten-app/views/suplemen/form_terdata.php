	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				<a href="<?= site_url("suplemen"); ?>" class="btn btn-social btn-box btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Suplemen"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Suplemen</a>
				<a href="<?= site_url("suplemen/rincian/$suplemen[id]"); ?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Rincian Data Suplemen</a>
			</div>
			...
			<div class="box-body">
				...
				<div id="form-melengkapi-data-peserta">
					<form id="validasi" action="<?= "$form_action/$suplemen[id]"; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
						...
						<?php if ($individu): ?>
							<?php include("kabupaten-app/views/suplemen/konfirmasi_terdata.php"); ?>
						<?php endif; ?>
						<div class="form-group">
