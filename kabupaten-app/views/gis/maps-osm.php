...
<div class="content-wrapper">
	<form id="mainform_map" name="mainform_map" action="" method="post">
		<div class="row">
			<div class="col-md-12">
				<div id="map">
					<?php include("kabupaten-app/views/gis/cetak_peta.php"); ?>
					...
					<div class="leaflet-top leaflet-right">
						...
						<?php $this->load->view("gis/content_desa.php", array('kabupaten' => $kabupaten, 'list_ref' => $list_ref, 'wilayah' => ucwords($this->setting->sebutan_desa . ' ' . $kabupaten['nama_desa']))) ?>
