                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="<?= site_url('first') ?>">
                                <img src="<?= gambar_kabupaten($kabupaten['logo']) ?>" style="padding-bottom: 5px; width:38px;" alt="Logo">
                            </a>&nbsp;
            ...
            <div class="inner-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="copyright"><?= ucfirst($this->setting->sebutan_desa) . ' ' . ucwords($kabupaten['nama_desa']) ?> <?= ucfirst($this->setting->sebutan_kecamatan) . ' ' . ucwords($kabupaten['nama_kecamatan']) ?> Kabupaten Garut &copy;
