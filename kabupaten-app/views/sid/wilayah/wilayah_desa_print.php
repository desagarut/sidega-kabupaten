		...
		<div id="container">
			...
			<div id="body">
				<div class="header" align="center">
					...
					<h4>DESA/KELURAHAN WILAYAH <?= strtoupper($this->setting->sebutan_kecamatan)?> <?= strtoupper($kecamatan)?></h4>
				</div>
				<br>
					<table class="border thick">
						<thead>
							<tr class="border thick">
								<th width="30">No</th>
								<th width="50">desa</th>
								<th width="100">NIK Kepala Desa/Lurah</th>
								<th width="100">Nama Kepala Desa/Lurah</th>
						...
						<tbody>
							<?php foreach ($main as $data): ?>
								<tr>
									...
									<td align="center" class="textx"><?= $data['desa']?></td>
									<td class="textx"><?= $data['nik_kades']?></td>
