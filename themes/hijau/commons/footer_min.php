...
<footer id="footer">
  ...
  <nav class="footer-links text-lg-right text-center pt-2 pt-lg-0 navbar-dark bg-success navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom" style="opacity:0.7">
