		...
		<div id="container">
			...
			<div id="body">
				<div class="header" align="center">
					...
					<h4> <?= ucwords($this->setting->sebutan_kabupaten)?> <?= $kabupaten['kabupaten']['nama_kabupaten']?>, <?= ucwords($this->setting->sebutan_kecamatan)?> <?= $kabupaten['kabupaten']['nama_kecamatan']?>, <?= ucwords($this->setting->sebutan_desa)?> <?= $kabupaten['kabupaten']['nama_desa']?></h4>
				</div>
				<br>
				...
				<?php include("kabupaten-app/views/global/blok_ttd_pamong.php"); ?>
			</div>
