...
class Dpt extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->list_session = ['cari', 'sex', 'kecamatan', 'desa', 'dusun', 'rw', 'rt', 'tanggal_pemilihan', 'umurx', 'umur_min', 'umur_max', 'cacatx', 'menahunx', 'pekerjaan_id', 'status', 'agama', 'pendidikan_sedang_id', 'pendidikan_kk_id', 'status_penduduk'];
	}
