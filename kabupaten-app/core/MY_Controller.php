...
class MY_Controller extends CI_Controller {
	...
	function __construct()
	{
		...
		$theme = preg_replace("/kabupaten\//","",strtolower($this->setting->web_theme)) ;
		$theme_folder = preg_match("/kabupaten\//", strtolower($this->setting->web_theme)) ? "kabupaten/themes" : "themes";
	...
	{
		$cluster_session = array('kabupaten', 'desa', 'kecamatan', 'desa', 'dusun', 'rw', 'rt');
