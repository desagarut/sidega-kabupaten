...
function set_marker(marker, daftar_path, judul, nama_wil, favico_kabupaten)
{
...
function set_marker_kabupaten(marker_kabupaten, kabupaten, judul, favico_kabupaten)
{
	var daerah_kabupaten = JSON.parse(kabupaten['path']);
  var jml = daerah_kabupaten[0].length;
  daerah_kabupaten[0].push(daerah_kabupaten[0][0]);
  for (var x = 0; x < jml; x++)
  {
    daerah_kabupaten[0][x].reverse();
  }
  ...
  var style_polygon = {
		...
		opacity: 1,
		weight: 3,
		fillColor: kabupaten['warna'],
		fillOpacity: 0.8,
    dashArray: 4
	};

  var point_style = stylePointLogo(favico_kabupaten);
  if (kabupaten['lng'])
  {
    marker_kabupaten.push(turf.point([kabupaten['lng'], kabupaten['lat']], {content: kabupaten, style: L.icon(point_style)}));
  }
  marker_kabupaten.push(turf.polygon(daerah_kabupaten, {content: kabupaten, style: style_polygon}));
}

function set_marker_desa_content(marker_kabupaten, kabupaten, judul, favico_kabupaten, contents)
{
	var daerah_kabupaten = JSON.parse(kabupaten['path']);
  var jml = daerah_kabupaten[0].length;
  daerah_kabupaten[0].push(daerah_kabupaten[0][0]);
  ...
  if (kabupaten['lng'])
  {
    marker_kabupaten.push(turf.point([kabupaten['lng'], kabupaten['lat']], {name: "kantor_kabupaten", content: "Kantor Desa", style: L.icon(point_style)}));
  }
  marker_kabupaten.push(turf.polygon(daerah_kabupaten, {content: content, style: style_polygon}));
}

function set_marker_content(marker, daftar_path, judul, nama_wil, contents, favico_kabupaten)
{
  var daftar = JSON.parse(daftar_path);
  var jml = daftar.length;
  var jml_path;
...
function getBaseLayers(peta, access_token)
{
	...
	var defaultLayer = L.tileLayer.provider('OpenStreetMap.Mapnik', {attribution: '<a href="https://openstreetmap.org/copyright">© OpenStreetMap</a> | <a href="https://garutkab.go.id/"></a>'}).addTo(peta);
  ...
  if (access_token)
  {
    mbGLstr = L.mapboxGL({
      ...
      attribution: '<a href="https://www.mapbox.com/about/maps">© Mapbox</a> | <a href="https://garutkab.go.id/">Kab. Garut</a>',
    });

    mbGLsat = L.mapboxGL({
  		accessToken: access_token,
  		style: 'mapbox://styles/mapbox/satellite-v9',
  		attribution: '<a href="https://www.mapbox.com/about/maps">© Mapbox</a> | <a href="https://garutkab.go.id/">Kab. Karut</a>',
  	});
    ...
    mbGLstr = L.tileLayer.provider('OpenStreetMap.Mapnik', {attribution: '<a href="https://openstreetmap.org/copyright">© OpenStreetMap</a> | <a href="https://garutkab.go.id/">Kab. Garut</a>'}).addTo(peta);
    mbGLsat = L.tileLayer.provider('OpenStreetMap.Mapnik', {attribution: '<a href="https://openstreetmap.org/copyright">© OpenStreetMap</a> | <a href="https://garutkab.go.id/">Kab. Garut</a>'}).addTo(peta);
    mbGLstrsat = L.tileLayer.provider('OpenStreetMap.Mapnik', {attribution: '<a href="https://openstreetmap.org/copyright">© OpenStreetMap</a> | <a href="https://garutkab.go.id/">Kab. Garut</a>'}).addTo(peta);
  }

	var baseLayers = {
		'OpenStreetMap': defaultLayer,
		'OpenStreetMap H.O.T.': L.tileLayer.provider('OpenStreetMap.HOT', {attribution: '<a href="https://openstreetmap.org/copyright">© OpenStreetMap</a> | <a href="https://garutkab.go.id/">Kab. Garut</a>'}),
...
function poligonWil(marker)
{
    ...
    onEachFeature: function (feature, layer) {
    	if (feature.properties.name == 'kantor_kabupaten')
    	{
    		// Beri classname berbeda, supaya bisa gunakan css berbeda
	      layer.bindPopup(feature.properties.content, {'className' : 'kantor_kabupaten'});
    	}
    	else
    	{
...
function overlayWil(marker_kabupaten, marker_dusun, marker_rw, marker_rt, sebutan_desa, sebutan_dusun)
{
  var poligon_wil_desa = poligonWil(marker_kabupaten);
...
//Menambahkan legend ke peta kabupaten
