              ...
              <div class="row">
                <div class="col-md-3 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p>Jumlah<strong> Seluruh Penduduk</strong> tercatat di <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?> </p>
                  </div>
                </div>
                ...
                <div class="col-md-3 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p>Jumlah <strong>Kepala Keluarga</strong> total tercatat di <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></p>
                  </div>
                </div>
                ...
                <div class="col-md-3 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p>Jumlah <strong>Rumah Tangga </strong> bahagia tercatat di <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></p>
                  </div>
                </div>
                ...
                <div class="col-md-3 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <p>Jumlah <strong>Surat </strong> terlayani di <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
