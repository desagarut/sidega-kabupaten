...
<page orientation="portrait" format="210x330" style="font-size: 10pt">
	...
	<table style="margin-top: 10px;" class="disdukcapil">
		...
		<tr>
			...
			<?php for ($i = 0; $i < 4; $i++) : ?>
				<td class="kotak tengah">
					<?php if (isset($config['kode_deskel'][$i])) : ?>
						<?= substr($config['kode_deskel'], 6, 10)[$i]; ?>
					<?php else : ?>
						&nbsp;
					<?php endif; ?>
				</td>
			<?php endfor; ?>
			<td class="kanan">*)</td>
			<td class="kotak"><?= $config['nama_deskel']; ?></td>
		</tr>
		<tr>
	...
	<table class="disdukcapil">
		...
		<tr>
			...
			<td colspan=8 class="kotak"><?= $config['nama_deskel']; ?></td>
	...
	<table class="ttd">
		...
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><?= $config['nama_deskel'] ?>, <?= tgl_indo(date("Y m d")); ?></td>
		</tr>
		<tr>
			<td>Mengetahui,</td>
			<td>Mengetahui,</td>
