...
<table class="title" leaflet-browser-print-content width="100%" style="border: solid 1px grey; text-align: center;">
  ...
  <tr>
    <?php if ($wilayah == $nama_wilayah): ?>
      <td align="center"><img src="<?= gambar_kabupaten($wil_atas['logo']);?>" alt="logo"  class="logo_mandiri"></td>
    <?php elseif (in_array($wilayah, array(ucwords($this->setting->sebutan_dusun), "RW", "RT"))): ?>
      <td align="center"><img src="<?= gambar_kabupaten($logo['logo']);?>" alt="logo"  class="logo_mandiri"></td>
    <?php else: ?>
      <td align="center"><img src="<?= gambar_kabupaten($kabupaten['logo']);?>" alt="logo"  class="logo_mandiri"></td>
    <?php endif; ?>
  </tr>
  <tr>
    <td>
      ...
      <?php else: ?>
        <h5 class="title text-center">PEMERINTAH <?= strtoupper($this->setting->sebutan_kabupaten)?></h5>
        <h5 class="title text-center"><?= strtoupper($kabupaten['nama_kabupaten'])?></h5>
        <h5 class="title text-center"><?= strtoupper($this->setting->sebutan_kecamatan)?></h5>
        <h5 class="title text-center"><?= strtoupper($kabupaten['nama_kecamatan'])?></h5>
        <h5 class="title text-center"><?= strtoupper($this->setting->sebutan_desa)?></h5>
        <h5 class="title text-center"><?= strtoupper($kabupaten['nama_desa'])?></h5>
      <?php endif; ?>
    </td>
  </tr>
  <tr>
