        ...
        <div class="col-md-4"> 
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <div align="center">
                <p class="text-muted text-center"> <small> Hai <?= strtoupper($penduduk['nama'])?>, selamat datang di layanan <?= ucwords($this->setting->sebutan_desa . " " . $kabupaten['nama_desa']); ?>, anda login sebagai </small> </p>
