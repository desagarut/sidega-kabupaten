...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="content" class="container_12 clearfix">
			<div id="content-main">
			 <div class="header">
				<h4 class="kop">DATA PBB SPPT</h4>
				<h4 class="kop">NOMOR OBJEK PAJAK: <?= sprintf("%04s", $sppt['nomor'])?></h4>
			...
			<div id="isi">
				<table style="font-size: 14px;padding-left: 32px;margin-left: 7px; margin-bottom: unset;">
					<tr>
						...
						<td width="10">:</td>
						<td><b><?= strtoupper($sppt["namawajibpajak"])?></b></td>
					</tr>
					<tr>
						<td>ALAMAT</td>
						<td>:</td>
						<td><?= strtoupper($sppt["alamat"])?></td>
					</tr>
				</table>
				<div align="center">
						...
						<tr>
							...
							<td>
								<p align="center"> <?= $kabupaten['nama_desa'] ?>, <?= tgl_indo(date("Y m d"))?><br>
									...
									<br>
									<br>
									<?= strtoupper($kabupaten['nama_kepala_desa']) ?>
								</p>
							</td>
						</tr>
					</table>
