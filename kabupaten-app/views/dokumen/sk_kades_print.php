			...
			<div id="body">
				...
				<table id="header" style="border-top: 0px;">
					<tr>
						<td colspan="6" align="center" style="font-size: 13.5pt;">
							<strong>BUKU KEPUTUSAN DESA <?= strtoupper($kabupaten['nama_desa'])?></strong>
						</td>
					</tr>
					<tr>
						<td colspan="6" align="center" style="font-size: 13.5pt;">
							<strong><?= strtoupper($this->setting->sebutan_kecamatan.' '.$kabupaten['nama_kecamatan'].' '.$this->setting->sebutan_kabupaten.' '.$kabupaten['nama_kabupaten'])?></strong>
						</td>
					</tr>
					<tr>
						<td colspan="6" align="center" style="font-size: 13.5pt;">
				...
				<table id="ttd" width="100%">
					...
					<tr>
						...
						<td colspan="2"><span class="underline"><?= strtoupper($this->setting->sebutan_desa.' '.$kabupaten['nama_desa'].', '.tgl_indo(date("Y m d")))?></span></td>
					</tr>
					<tr>
						<td colspan="1">&nbsp;</td>
