...
<head>
	...
	<title> <?= $this->setting->login_title
				. ' ' . strtoupper($this->setting->sebutan_kabupaten_singkat)
				. (($header['nama_kabupaten']) ? ' ' . $header['nama_kabupaten'] : '')
					...
					<div class="col-md-4">
						<div class="card-body">
							<div class="brand-wrapper" align="center">
								<a href="<?= site_url('first'); ?>"><img src="<?= gambar_kabupaten($header['logo']); ?>" alt="<?= $header['nama_kabupaten'] ?>" class="img-responsive" style="max-width: 80px; max-height: 80px" /></a>
							</div>
							<h1 align="center" style="font-size:18px"><?= $this->setting->login_title ?></h1>
