<table width="100%" style="border: solid 0px black; text-align: center;">
	<tr>
		...
		<td>
			...
			<h4>PEMERINTAH <?= strtoupper(ucwords($this->setting->sebutan_desa))?> <?= strtoupper($kabupaten['nama_desa'])?></h4>
			<?php if (!empty($sm)): ?>
			<h4>SEMESTER <?= $sm ?></h4>
			<?php endif; ?>
...
<?php include('kabupaten-app/views/keuangan/tabel_laporan_rp_apbd_isi.php'); ?>
