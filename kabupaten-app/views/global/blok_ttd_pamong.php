				<table>
					...
					<tr>
						...
						<td colspan="2" class="nowrap"><?= ucwords($this->setting->sebutan_desa)?> <?= $kabupaten['nama_desa']?>, <?= tgl_indo(date("Y m d"))?></td>
						<td style="width: 20%">&nbsp;</td>
					</tr>
					<tr>
						<td colspan="<?= $spasi_kiri ?>">&nbsp;</td>
						<td class="nowrap"><?= $pamong_ketahui['jabatan']?> <?= $kabupaten['nama_desa']?></td>
						<td colspan="<?= $spasi_tengah ?>">&nbsp;</td>
						<td colspan="2" class="nowrap"><?= $pamong_ttd['jabatan']?> <?= $kabupaten['nama_desa']?></td>
						<td>&nbsp;</td>
					</tr>
