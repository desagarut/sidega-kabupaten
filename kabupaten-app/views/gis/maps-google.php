...
function initMap() {
    ...
    PetaDesa = new google.maps.Map(document.getElementById("peta_wilayah_desa"), { center, zoom:<?=$kabupaten['zoom']?>, mapTypeId:google.maps.MapTypeId.<?=$kabupaten['map_tipe']?> });
    ...
    kantorDesa = new google.maps.Marker({
		...
		icon: '<?= gambar_kabupaten($kabupaten['logo']); ?>',
    });
