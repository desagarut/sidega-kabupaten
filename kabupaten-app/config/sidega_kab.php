...
define("LOKASI_SID_INI", 'kabupaten/config/');
...
// Untuk situs yang digunakan untuk demo, seperti https://pantau.desagarut.net,
...
/* End of file sidega_kab.php */
/* Location: ./application/config/sidega_kab.php */
