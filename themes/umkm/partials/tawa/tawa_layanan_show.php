    ...
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          ...
          <p>Informasi usaha jasa transportasi, ojeg, rental mobil, angkutan barang, odong-odong dll di <?= ucfirst($this->setting->sebutan_desa).' '.ucwords($kabupaten['nama_desa']) ?></p>
        </div>
      </div>
    </div>
